...
class SitToStandCounter:
    ...
    def evaluate_score(self, count, age, gender):
        ...
        Returns assessment and interpretation
        """
        ...
        if count < threshold:
            ...
            interpretation = (
                "This suggests adequate lower-body strength for daily activities."
            )
    ...
    def show_result_overlay(self, cap, final_result, test_status):
        ...
        while True:
            ...
            cv2.putText(frame, final_result.get('assessment', 'Result not available'),(40, 200),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.9, (200, 255, 200), 2)

            cv2.putText(frame,"This test measures leg strength only and is not a diagnosis.",(40, 235),
